...
# get host name
hosts_file="hosts_vit_4_16_adamw.txt"
...
makehostfile > hostfile_vit_4_16_adamw
...
deepspeed --num_gpus 4 --num_nodes 1  --hostfile hostfile_vit_4_16_adamw project_5/VIT_cifar_4_16_adamw.py > 4_16_vit_adamw.txt # 4 gpu/per node = 4GPUs
