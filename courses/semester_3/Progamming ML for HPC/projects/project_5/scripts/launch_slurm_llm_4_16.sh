...
makehostfile > hostfile_llm_4_16
...
deepspeed --num_gpus 4 --num_nodes 1  --hostfile hostfile_llm_4_16 project_5/LLM_4_16.py > 4_16_llm.txt # 4 gpu/per node = 4GPUs
