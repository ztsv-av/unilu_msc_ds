...
# get host name
hosts_file="hosts_cifar_4_16.txt"
...
makehostfile > hostfile_vit_4_16
...
deepspeed --num_gpus 4 --num_nodes 1  --hostfile hostfile_vit_4_16 project_5/VIT_cifar_4_16.py > 4_16_vit.txt # 4 gpu/per node = 4GPUs
