...
makehostfile > hostfile_llm_4_32
...
deepspeed --num_gpus 4 --num_nodes 1  --hostfile hostfile_llm_4_32 project_5/LLM_4_32.py > 4_32_llm.txt # 4 gpu/per node = 4GPUs
