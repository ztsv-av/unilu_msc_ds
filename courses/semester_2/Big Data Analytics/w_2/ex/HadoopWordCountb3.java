...
public class HadoopWordCountb3 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(new Configuration(), "HadoopWordCountb3");
		job.setJarByClass(HadoopWordCountb3.class);
	...
	public static void main(String[] args) throws Exception {
		int ret = ToolRunner.run(new Configuration(), new HadoopWordCountb3(), args);
		System.exit(ret);
	}
}
